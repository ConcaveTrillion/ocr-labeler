...
from pd_ocr_labeler.state.page_state import (
    PageState,
...
def test_refine_words_refreshes_overlay_and_notifies(monkeypatch):
    ...
    import pd_ocr_labeler.state.page_state as ps_module
...
def test_update_word_ground_truth_notifies_on_success(monkeypatch):
    ...
    from pd_ocr_labeler.operations.ocr import line_operations as line_ops_module
